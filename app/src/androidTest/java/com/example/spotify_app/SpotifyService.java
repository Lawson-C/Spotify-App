...
public class SpotifyService {
    ...
    public void onGetUserProfileInfoClicked(TextView tokenTextView, TextView identifierTextView, String identifier) {
        String endpoint;
        if (identifier.equals("top_tracks")) {
            endpoint = "https://api.spotify.com/v1/me/top/tracks";
        } else if (identifier.equals("top_artists")) {
